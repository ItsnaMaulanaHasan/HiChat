        ...
        auth.signInWithEmailAndPassword(email,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    Intent intent = new Intent(MyLoginActivity.this,MainActivity.class);
                    Toast.makeText(MyLoginActivity.this, "Sign in is succesfull", Toast.LENGTH_SHORT).show();
                    startActivity(intent);
                }
                else{
                    Toast.makeText(MyLoginActivity.this, "Sign in is not succesfull", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
